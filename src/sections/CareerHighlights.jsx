...
export default function CareerHighlights() {
  const quote = "I was fortunate enough to be Ernesto's mentor through the Emerging Leaders Mentoring program. He is ambitious, passionate, and always eager to grow as a Software Engineer. He is able to take on many challenges, and manage ambiguity to craft intentional solutions. It was inspiring to see him develop and achieve his goals.";
